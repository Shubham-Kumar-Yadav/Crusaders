  ...
  (l.fn.lazyload = function (e) {
    ...
    function i() {
      ...
      r.each(function () {
        var e = l(this);
        if (
          (!f.skip_invisible || e.is(":visible")) &&
          !l.abovethetop(this, f) &&
          !l.leftofbegin(this, f)
        )
    ...
    return (
      e &&
        ...
        l.extend(f, e)),
      (t = f.container === a || f.container === o ? h : l(f.container)),
      0 === f.event.indexOf("scroll") &&
        t.bind(f.event, function () {
          return i();
        }),
      this.each(function () {
        var o = this,
        ...
        (o.loaded = !1),
          (n.attr("src") !== a && !1 !== n.attr("src")) ||
            (n.is("img") && n.attr("src", f.placeholder)),
