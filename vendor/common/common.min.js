function scrollAndFocus(t, e, o, i, s) {
  ...
  (n = jQuery)("body").addClass("scrolling"),
    n(t).closest("#mainNav").get(0) &&
      n(t).parents(".collapse.show").collapse("hide"),
    n("html, body").animate(
...
if (
      ...
      browserSelector: function () {
        ...
        (c = d.join(" ")),
          ...
          /Edge/.test(navigator.userAgent) &&
            p("html").removeClass("chrome").addClass("edge"),
          !window.ActiveXObject && "ActiveXObject" in window
            ? p("html").removeClass("gecko").addClass("ie ie11")
  ...
  (function (e) {
    e(".recommend-themes").get(0) &&
      e("#demos").get(0) &&
      e(window).on("scroll", function (t) {
        e(window).scrollTop() + 1 >= e("#demos").offset().top
          ? e(".recommend-themes").addClass("active")
          : e(".recommend-themes").removeClass("active");
      });
  })(jQuery),
  (function (o) {
      ...
      o(document).on("click", "a", function (t) {
        ...
        o(window).on("beforeunload", function (t) {
          ...
          0 == e.indexOf("mailto:") ||
            ...
            o("body").addClass("page-transition-active");
        }),
    ...
    function d(t) {
      ...
      return (
        e.each(function () {
          ...
          null !== o && Math.floor(Math.abs(i - e)) <= 1
        ...
        : t.parents(".word-rotator").hasClass("clip") &&
          (document.hasFocus()
            ? t
                .parents(".word-rotator-words")
                .stop(!0, !0)
                .animate({ width: t.outerWidth() + 10 }, u, function () {
                  setTimeout(function () {
                    h(t);
                  }, o);
                })
    ...
    build: function () {
      ...
      o(window).height() - o(".header-body").height() < t
        ? (o("#footer").removeClass("footer-reveal"),
          o("body").css("margin-bottom", 0))
        : (o("#footer").addClass("footer-reveal"),
          o("body").css("margin-bottom", t));
    },
    events: function () {
      var t = this,
        e = o(window);
