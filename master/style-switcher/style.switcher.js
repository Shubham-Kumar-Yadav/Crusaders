var styleSwitcher = {
  ...
  initialize: function () {
    var t = this,
      ...
      i = $("#styleSwitcherScript").data("base-path")
        ? $("#styleSwitcherScript").data("base-path")
        : "",
      o = $("head"),
      e = $("#styleSwitcherScript").data("skin-src")
        ? $("#styleSwitcherScript").data("skin-src")
        : i + "master/less/skin-default.less";
    (t.basePath = i),
      this.initialized ||
        ((t.options = $.extend({}, t.defaults)),
        (String.prototype.capitalize = function () {
          return this.charAt(0).toUpperCase() + this.slice(1);
        }),
        (jQuery.styleSwitcherCachedScript = function (o, e) {
          return (
            (e = $.extend(e || {}, { dataType: "script", cache: !0, url: o })),
            jQuery.ajax(e)
          );
        }),
        null != $.cookie("borderRadius") &&
          (t.options.borderRadius = $.cookie("borderRadius")),
        null != $.cookie("colorPrimary") &&
          (t.options.colorPrimary = "#" + $.cookie("colorPrimary")),
        null != $.cookie("colorSecondary") &&
          (t.options.colorSecondary = "#" + $.cookie("colorSecondary")),
        null != $.cookie("colorTertiary") &&
          (t.options.colorTertiary = "#" + $.cookie("colorTertiary")),
        null != $.cookie("colorQuaternary") &&
          (t.options.colorQuaternary = "#" + $.cookie("colorQuaternary")),
        r &&
          ((r = r.replace(/'/g, '"')),
          (t.options = $.extend({}, t.options, JSON.parse(r))),
          (t.options.preserveCookies = !0),
          (t.options.saveToStorage = !1)),
        o.append(
          $('<link rel="stylesheet">').attr(
            "href",
            i + "master/style-switcher/style-switcher.css"
          )
        ),
        $("[data-icon]").get(0) &&
        ...
        t.options.showSwitcher ||
        !$.cookie("initialized")
          ? (o.append($('<link rel="stylesheet/less">').attr("href", e)),
            o.append(
              $('<link rel="stylesheet">').attr(
                "href",
                i +
            ...
            $.styleSwitcherCachedScript(
              ...
              (less = {
                ...
                $.styleSwitcherCachedScript(i + "master/less/less.js").done(
                  function (o, e) {
                    $.ajax({
                      url: i + "master/style-switcher/style.switcher.html",
                    }).done(function (o) {
                      $("body").append(o),
                        (t.container = $("#styleSwitcher")),
                        t.build(),
                        t.events(),
                        "img/logo.png" !=
                          $("#header .header-logo img").attr("src") &&
                          (t.options.changeLogo = !1),
                        r ||
                          (null != $.cookie("layoutStyle") &&
                            (t.options.layoutStyle = $.cookie("layoutStyle")),
                          $("body").hasClass("one-page") &&
                            (t.options.websiteType = "one-page"),
                          null != $.cookie("backgroundColor") &&
                            (t.options.backgroundColor = $.cookie(
                              "backgroundColor"
                            )),
                          null != $.cookie("backgroundPattern") &&
                            (t.options.backgroundPattern = $.cookie(
                              "backgroundPattern"
                            ))),
                        t.setLayoutStyle(t.options.layoutStyle),
                        t.setWebsiteType(t.options.websiteType),
                        t.setBackgroundColor(t.options.backgroundColor),
                        t.setBackgroundPattern(t.options.backgroundPattern),
                        t.setColors(),
                        t.setBorderRadius(t.options.borderRadius),
            ...
            $.styleSwitcherCachedScript(
              i + "master/style-switcher/cssbeautify/cssbeautify.js"
            ).done(function (o, e) {}))
          : t.initializeSimpleMode());
  },
  initializeSimpleMode: function () {
    ...
    $("body").append(
      '<div id="styleSwitcherSimple" class="style-switcher style-switcher-simple d-none d-sm-block"><a id="styleSwitcherSimpleOpen" class="style-switcher-open" href="#"><i class="fas fa-cogs"></i><div class="style-switcher-tooltip"><strong>Style Switcher</strong><p>Check out different color options and styles.</p></div></a></div>'
    ),
      o ||
        (setTimeout(function () {
        ...
        localStorage.setItem("porto-style-switcher-tooltip", !0)),
      "img/logo.png" == r && e.setLogo(),
      $("#styleSwitcherSimpleOpen").on("click", function (o) {
        o.preventDefault(),
          t.attr("src", r),
          $(this)
            .find(".fa")
            .removeClass()
            .addClass("fas fa-cog fa-spin fa-fw"),
  ...
  build: function () {
    ...
    t.val(e.options.colorPrimary).parent().colorpicker(),
      r.val(e.options.colorSecondary).parent().colorpicker(),
      i.val(e.options.colorTertiary).parent().colorpicker(),
      a.val(e.options.colorQuaternary).parent().colorpicker(),
      $(".colorpicker")
        ...
        .on("mouseup", function (o) {
          o.preventDefault(),
            (e.isChanging = !1),
            (e.options.colorPrimary = t.val()),
            (e.options.colorSecondary = r.val()),
            (e.options.colorTertiary = i.val()),
            (e.options.colorQuaternary = a.val()),
            e.setColors();
        }),
      ...
      this.container.find(".options-links.layout a").on("click", function (o) {
        o.preventDefault(),
          e.setLayoutStyle($(this).attr("data-layout-type"), !0);
      }),
      this.container
        .find(".options-links.website-type a")
        .on("click", function (o) {
          o.preventDefault(),
            $.cookie("showSwitcher", !0),
      ...
      this.container
        ...
        .on("click", function (o) {
          o.preventDefault(),
            e.setBackgroundColor($(this).attr("data-background-color"));
        }),
      this.container
        .find("ul[data-type=patterns]")
        .find("a")
        .on("click", function (o) {
          o.preventDefault(),
            e.setBackgroundPattern($(this).attr("data-pattern"));
        }),
  ...
  setColors: function (o, e) {
    ...
    o &&
      ((t.options["color" + e.capitalize()] = o),
      t.container.find(".color-" + e + " input").val(o)),
      t.options.preserveCookies ||
        ($.cookie("colorPrimary", t.options.colorPrimary.replace("#", "")),
        $.cookie("colorSecondary", t.options.colorSecondary.replace("#", "")),
        $.cookie("colorTertiary", t.options.colorTertiary.replace("#", "")),
        $.cookie(
          "colorQuaternary",
          t.options.colorQuaternary.replace("#", "")
        )),
      t.modifyVars(),
      this.setLogo();
  },
  setBorderRadius: function (o) {
    ...
    t.find(".active").removeClass("active"),
      t.find("a[data-border-radius=" + o + "]").addClass("active"),
      $.event.trigger({ type: "styleSwitcher.setBorderRadius", radius: o });
  },
  setLayoutStyle: function (o, e) {
    ...
    if (
      ...
      this.options.saveToStorage &&
        ...
        localStorage.setItem("porto-layout", o),
      e)
    )
    ...
    t.find(".active").removeClass("active"),
      t.find("a[data-layout-type=" + o + "]").addClass("active"),
      "wide" == o
        ? (r.hide(),
        ...
        : (r.show(),
          ...
          null == $.cookie("backgroundPattern") &&
            this.container
              .find("ul[data-type=patterns] li:first a")
              .trigger("click")),
  ...
  setWebsiteType: function (o) {
    ...
    "one-page" == o
      ? (e.find("a:last").addClass("active"), t.prev().remove(), t.remove())
  ...
  setBackgroundColor: function (o) {
    ...
    e.find(".active").removeClass("active"),
      ...
      "dark" == o ? $("html").addClass("dark") : $("html").removeClass("dark"),
      $.event.trigger({ type: "styleSwitcher.setBackgroundColor", color: o }),
      this.setLogo();
  },
  setBackgroundPattern: function (o) {
    if ("" == o) return this;
    $("html").hasClass("boxed") &&
      $("html").css("background-image", "url(img/patterns/" + o + ".png)"),
      this.options.preserveCookies || $.cookie("backgroundPattern", o),
      $.event.trigger({
  ...
  reset: function () {
    $.removeCookie("borderRadius"),
      ...
      "undefined" != typeof localStorage &&
        (localStorage.removeItem("porto-skin.css"),
  ...
  getCss: function () {
    (raw = ""),
      $("html").hasClass("boxed")
        ? ((raw =
            'html { background-image: url("../../img/patterns/' +
      ...
      (options = { indent: "\t", autosemicolon: !0 }),
