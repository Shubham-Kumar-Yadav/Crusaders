...
(function ($) {
      ...
      $.ajax({
        ...
        complete: function complete(data) {
          ...
          setTimeout(function () {
            ...
            self.$loader.hide(); // Refresh Parallax
            ...
            self.$wrapper.on('layoutComplete', function (laidOutItems) {
              ...
              self.$wrapper.find('.item-appended').each(function () {
                var imgsrc = $(this).find('.thumb-info-background').attr('data-src'),
                    ...
                    cloneThumb = $('#thumbGalleryThumbs .owl-item > div').first().clone(); // Create images

                clone.find('img').attr('src', imgsrc);
                cloneThumb.find('img').attr('src', imgThumbsrc); // Add images
  ...
  */
  ...
  var ajaxOnPagePortfolioDetails = {
    ...
    events: function events() {
      ...
      sliderOptions.navigation.mouseScrollNavigation = false;
      $('#revolutionSlider').revolution(sliderOptions); // Carousel
  ...
  $(window).on('load', function () {
    var $portfolioGrid = $('#portfolioGrid'),
        $ourBlog = $('#ourBlog'),
        gridSizer = $portfolioGrid.attr('data-grid-sizer'); // Portfolio Grid
  ...
  */
    ...
    buttonNavigation: function buttonNavigation() {
      ...
      prevButton.on('click', function () {
        if (!flag) {
          ...
          atualItem = self.$horizontalScrollItem.eq(index); // Check if Element in View
  ...
  if ($('#horizontalScrollBox').get(0)) {
    ...
    var $window = $(window); // Mousewheel horizontal scroll
  ...
  */
  ...
  if ($('#photographyLightbox').get(0)) {
    ...
    $thumbGalleryDetail.owlCarousel({
      ...
      if (!flag) {
        flag = true;
        $thumbGalleryThumbs.trigger('to.owl.carousel', [e.item.index - 1, duration, true]); // add class to active thumb
    ...
    $thumbGalleryThumbs.owlCarousel({
      ...
      $thumbGalleryDetail.trigger('to.owl.carousel', [$(this).index(), duration, true]); // add class to active thumb
