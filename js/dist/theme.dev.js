...
}).apply(void 0, [window.theme, jQuery]); // Before / After
...
}).apply(void 0, [window.theme, jQuery]); // Carousel
...
(function (theme, $) {
  ...
  PluginCarousel.prototype = {
    ...
    build: function build() {
      ...
      $el.owlCarousel(this.options).addClass('owl-carousel-init'); // Sync
...
}).apply(void 0, [window.theme, jQuery]); // Chart Circular
...
}).apply(void 0, [window.theme, jQuery]); // Countdown
...
}).apply(void 0, [window.theme, jQuery]); // Counter
...
}).apply(void 0, [window.theme, jQuery]); // Float Element
...
}).apply(void 0, [window.theme, jQuery]); // Icon
...
}).apply(void 0, [window.theme, jQuery]); // Lazy Load
...
}).apply(void 0, [window.theme, jQuery]); // Lightbox
...
}).apply(void 0, [window.theme, jQuery]); // Loading Overlay
...
}).apply(void 0, [window.theme, jQuery]); // Masonry
...
}).apply(void 0, [window.theme, jQuery]); // Match Height
...
}).apply(void 0, [window.theme, jQuery]); // Parallax
  ...
  PluginParallax.prototype = {
    ...
    build: function build() {
      var self = this,
          ...
          yPos,
          bgpos,
          background; // Create Parallax Element

      background = $('<div class="parallax-background"></div>'); // Set Style for Parallax Element
...
}).apply(void 0, [window.theme, jQuery]); // Progress Bar
...
}).apply(void 0, [window.theme, jQuery]); // Revolution Slider
...
}).apply(void 0, [window.theme, jQuery]); // Scroll to Top
...
}).apply(void 0, [window.theme, jQuery]); // Scrollable
...
}).apply(void 0, [window.theme, jQuery]); // Section Scroll
...
}).apply(void 0, [window.theme, jQuery]); // Sort
...
}).apply(void 0, [window.theme, jQuery]); // Star Rating
...
}).apply(void 0, [window.theme, jQuery]); // Sticky
...
}).apply(void 0, [window.theme, jQuery]); // Toggle
...
}).apply(void 0, [window.theme, jQuery]); // Tweets
...
}).apply(void 0, [window.theme, jQuery]); // Validation
...
}).apply(void 0, [window.theme, jQuery]); // Video Background
...
}).apply(void 0, [window.theme, jQuery]); // Account
...
}).apply(void 0, [window.theme, jQuery]); // Nav
...
}).apply(void 0, [window.theme, jQuery]); // Newsletter
...
}).apply(void 0, [window.theme, jQuery]); // Search
...
}).apply(void 0, [window.theme, jQuery]); // Sticky Header
    ...
    StickyHeader: {
      ...
      build: function build() {
        ...
        if ($html.hasClass('boxed') && self.options.stickyEffect == 'shrink') {
          ...
          self.options.headerBody.css('position', 'absolute'); // Set position absolute because top margin from boxed layout
        ...
        self.deactivateStickyHeader = function () {
          $html.removeClass('sticky-header-active'); // Sticky Effect - Shrink
...
}).apply(void 0, [window.theme, jQuery]);